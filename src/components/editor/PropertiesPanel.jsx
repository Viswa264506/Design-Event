          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <div className="flex items-center bg-[#F8FAFF] border border-[#E5E7EB] rounded-xl px-2.5 py-1.5 focus-within:border-[#2563EB]">
              ...
              <input
                ...
                className="w-full bg-transparent text-xs text-[#111827] font-mono font-bold focus:outline-none disabled:opacity-40"
              />
            </div>
          </div>
        </div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (el.type === 'text') handleChange('color', val);
                    else handleChange('backgroundColor', val);
                  }}
